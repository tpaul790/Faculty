#ifndef LAB6_ISTVAN_VECTORDINAMICTEMPLATE_H
#define LAB6_ISTVAN_VECTORDINAMICTEMPLATE_H
...
*/
template<typename ElementT>
VectDinNewDeleteT<ElementT>::VectDinNewDeleteT() :elems{ new ElementT[5] }, cap{ 5 }, lg{ 0 } {}
...
#endif //LAB6_ISTVAN_VECTORDINAMICTEMPLATE_H
